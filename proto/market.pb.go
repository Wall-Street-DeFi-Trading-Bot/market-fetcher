...
type Header struct {
	...
	SourceTsNs  int64      `protobuf:"varint,5,opt,name=source_ts_ns,json=sourceTsNs,proto3" json:"source_ts_ns,omitempty"`
	PublishTsNs int64      `protobuf:"varint,6,opt,name=publish_ts_ns,json=publishTsNs,proto3" json:"publish_ts_ns,omitempty"`
...
func (x *Header) GetSourceTsNs() int64 {
	if x != nil {
		return x.SourceTsNs
	}
	return 0
...
func (x *Header) GetPublishTsNs() int64 {
	if x != nil {
		return x.PublishTsNs
	}
	return 0
}
...
type DexSwapL1 struct {
	...
	Token0         string `protobuf:"bytes,24,opt,name=token0,proto3" json:"token0,omitempty"`                                        // symbol
	Token1         string `protobuf:"bytes,25,opt,name=token1,proto3" json:"token1,omitempty"`                                        // symbol
	Token0Decimals uint32 `protobuf:"varint,26,opt,name=token0_decimals,json=token0Decimals,proto3" json:"token0_decimals,omitempty"` // e.g., 18
	Token1Decimals uint32 `protobuf:"varint,27,opt,name=token1_decimals,json=token1Decimals,proto3" json:"token1_decimals,omitempty"` // e.g., 18
	// --- Orientation & computed prices ---
	// price01 = token1/token0 (pool-native). price_qb = quote/base as requested by the symbol.
	InvertForQuote bool    `protobuf:"varint,28,opt,name=invert_for_quote,json=invertForQuote,proto3" json:"invert_for_quote,omitempty"` // true if we inverted price01 to form quote/base
	Price01        float64 `protobuf:"fixed64,29,opt,name=price01,proto3" json:"price01,omitempty"`                                      // price = (sqrtP/2^96)^2 * 10^(dec0-dec1)
	Price10        float64 `protobuf:"fixed64,30,opt,name=price10,proto3" json:"price10,omitempty"`                                      // price after invert if needed (what you publish as “mid”)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_market_proto_rawDesc = "" +
	"\n" +
	"\fmarket.proto\x12\x02md\"\xb3\x02\n" +
	"\x06Header\x12\x1a\n" +
	...
	"instrument\x12 \n" +
	"\fsource_ts_ns\x18\x05 \x01(\x03R\n" +
	"sourceTsNs\x12\"\n" +
	"\rpublish_ts_ns\x18\x06 \x01(\x03R\vpublishTsNs\x12%\n" +
	"\x0eschema_version\x18\a \x01(\rR\rschemaVersion\x12\x14\n" +
	"\x05chain\x18\b \x01(\tR\x05chain\x12!\n" +
	"\fpool_address\x18\t \x01(\tR\vpoolAddress\">\n" +
	"\x06TickL1\x12\x10\n" +
	...
	"\fblock_number\x18\x17 \x01(\x04R\vblockNumber\x12\x16\n" +
	...
	"\x10invert_for_quote\x18\x1c \x01(\bR\x0einvertForQuote\x12\x18\n" +
	"\aprice01\x18\x1d \x01(\x01R\aprice01\x12\x18\n" +
	"\aprice10\x18\x1e \x01(\x01R\aprice10\"\x8c\x01\n" +
	"\bSlippage\x12!\n" +
	...
	"\atx_hash\x18\x04 \x01(\tR\x06txHash\"z\n" +
	"\x06Volume\x12\x18\n" +
